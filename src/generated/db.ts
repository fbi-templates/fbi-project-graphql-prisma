...
export type PostOrderByInput = 'id_ASC' | 'id_DESC' | 'title_ASC' | 'title_DESC'
...
export interface UserWhereInput {
  ...
  gender_in?: Maybe<GenderEnum[] | GenderEnum>
  gender_not_in?: Maybe<GenderEnum[] | GenderEnum>
...
const typeDefs = readFileSync(join(__dirname, 'db.graphql'), 'utf8')
